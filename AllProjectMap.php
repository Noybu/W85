...
<div id="map" style="width:100vw; height:73vh; margin: 0 auto;"></div>
    ...
    <script>
      ...
      function geocodeAddress(geocoder, resultsMap) {
        var icons={
          t1 : {
              icon:'https://img.icons8.com/ios-filled/24/000000/city-bench.png'
          },
          t2 : { 
              icon:'https://img.icons8.com/ios/24/000000/playground.png'
          },
          t3 : {
              icon:'https://img.icons8.com/wired/24/000000/trash.png'
          },
          t4 : {
              icon:'https://img.icons8.com/material/24/000000/bike-path--v2.png'
          },
          t5 : {
              icon:'https://img.icons8.com/ios-filled/24/000000/street-lamp.png'
          }
        };
