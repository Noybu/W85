                    ...
                    <div class="descCard2">
                        ...
                        <div id="statusBar">
                            ...
                            <div class="bar2">
                                ...
                                <?php
                            //להמנע מחלוקה ב-0
                                if($arrFunds[$i]->projectcost==0){
                                    $projectCost=1;
                                }
                                else{
                                    $projectCost=$arrFunds[$i]->projectcost;
                                }
                            ?>
                                    <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" style="max-width:100%; min-width:2%; width:<?php echo ($arrFunds[$i]->projectcurrentprice/$projectCost)*100;?>%;border-radius: 20px; ">
